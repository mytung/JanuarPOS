...
<table class="table striped table-border mt-4" id="example" data-role="table" data-pagination="true">
	<thead>
		<tr>
			...
			<th class="sortable-column text-center" data-format="money">Logo</th>
	...
	<tbody>
		...
		<tr>
			...
			<td class="text-center">
				<a href="#" data-nama="{{$toko->namainstansi}}" onclick="Metro.dialog.open('#d-editToko')">Edit</a>
				<a href="{{route('toko.delete', $toko->id)}}">Delete</a>
			</td>
		</tr>
		@endforeach
	</tbody>
